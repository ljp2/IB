...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.candlestickWidget_1 = CandlestickWidget(self)
        self.candlestickWidget_2 = CandlestickWidget(self)
        
        
        self.candlestickWidget_1.setRange(xRange=(0,5), yRange=(0,5))
        self.candlestickWidget_2.setRange(xRange=(0,5), yRange=(0,5))
        
        self.candlestickWidget_2.setXLink(self.candlestickWidget_1)
        self.candlestickWidget_1.setMouseEnabled(x=True, y=False)
        ...
        layout = QVBoxLayout()
        layout.addWidget(self.candlestickWidget_1)
        layout.addWidget(self.candlestickWidget_2)
    ...
    def drawNextCandle(self):
        ...
        if current_candle_index < len(candles_to_draw):
            print(current_candle_index)
            candle_data = candles_to_draw[current_candle_index]
            self.candlestickWidget_1.plotCandle(candle_data)
            self.candlestickWidget_2.plotCandle(candle_data)
